...
<div class="page">
  <div class="page-header">
    <h1 class="page-title">Detail populasi sapi milik @foreach($anggota as $anggotas){{$anggotas->nama}}@endforeach</h1>
              ...
              <div class="nav-tabs-horizontal" data-plugin="tabs">
                ...
                <div class="tab-content pt-20">
                  <div class="tab-pane active" id="SapiBetina" role="tabpanel">
                    <form autocomplete="off" action="{{route('koordinator.store')}}" method="post">
                      @csrf
                      <div class="form-group row">
                        ...
                        @foreach ($anggota as $anggotas)
                        <input type="hidden" name="id_anggota" value="{{$anggotas->id}}">
                        <input type="hidden" name="wilayah" value="{{$anggotas->wilayah}}">
                        <input type="hidden" name="kelompok" value="{{$anggotas->kelompok}}">
                        @endforeach
