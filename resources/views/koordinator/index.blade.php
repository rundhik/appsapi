...
@section('content')
              ...
              <li class="site-menu-item has-sub">
                ...
                <ul class="site-menu-sub">
                  <li class="site-menu-item">
                    <a class="animsition-link" href="/koordinator/{{$k->id}}/anggota">
                      <span class="site-menu-title">Anggota</span>
                    </a>
                  </li>
                  <li class="site-menu-item">
                    <a class="animsition-link" href="/koordinator/{{$k->id}}/sapi">
    ...
    <div class="page">
        <div class="page-header">
            <h1 class="page-title">Selamat Datang {{$k->username}} Koordinator dari Wilayah {{$k->wilayah}} desa @foreach ($wil as $w) {{$w->nama_wil}} @endforeach</h1>
        ...
        <div class="page-content container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                <a style="text-decoration: none;" href="/koordinator/{{$k->id}}/anggota">
                ...
                <div class="col-md-6">
                <a style="text-decoration: none;" href="/koordinator/{{$k->id}}/sapi">
