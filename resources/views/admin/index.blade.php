        ...
        <li class="site-menu-item has-sub">
            ...
            <ul class="site-menu-sub">
              <li class="site-menu-item">
                <a class="animsition-link" href="{{route('anggotaadms.index')}}">
                  <span class="site-menu-title">Anggota</span>
              </a>
          </li>
          <li class="site-menu-item">
            <a class="animsition-link" href="{{route('sapiadms.index')}}">
...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">Selamat Datang Admin KPSP Setia Kawan</h1>
    ...
    <div class="page-content container-fluid">
        ...
        <div class="col-md-6">
            <a style="text-decoration: none;" href="{{route('anggotaadms.index')}}">
        ...
        <div class="col-md-6">
            <a style="text-decoration: none;" href="{{route('sapiadms.index')}}">
