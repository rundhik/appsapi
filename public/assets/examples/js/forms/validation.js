(function (global, factory) {
  ...
  // Validation Populasi Sapi Pedet Betina1
  // ------------------------
  (function () {
    (0, _jquery2.default)('#pedetBetina1')
    .formValidation({
      framework: "bootstrap4",
      button: {
        selector: '#tblPedetBetina1',
        disabled: 'disabled'
      },
      icon: null,
      fields: {
  ...
  // ------------------------
  (function () {
    (0, _jquery2.default)('#pedetBetina2')
    .formValidation({
      framework: "bootstrap4",
      button: {
        selector: '#tblPedetBetina2',
        disabled: 'disabled'
      },
      icon: null,
      fields: {
